...
const QuotationTable = ({
  ...
  useEffect(() => {
    const fetchLeadIds = async () => {
      const newLeadIds: Record<string, string> = {};
      await Promise.all(
        leads.map(async (lead) => {
  ...
  const filteredLeads = useMemo(() => {
    ...
    return filtered;
  }, [leads, searchQuery, sortKey, sortOrder, additionalFilter]);
                    ...
                    <TableCell className="w-max align-top">
                      <div className="w-44">
                        ...
                        >
                          ...
                          <span className="text-sm text-gray-500 dark:text-gray-300 flex items-center gap-1 line-clamp-1 truncate">
                            {lead.email}
                          </span>
                          <span className="text-sm text-gray-500 dark:text-gray-300 line-clamp-1 truncate">
                            {lead.number}
                          </span>
                        </a>
                      </div>
                      ...
                      {lead.quotationStatus ? (
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Documents will be available after payment
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      )}
