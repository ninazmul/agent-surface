        ...
        {paginatedNotifications.map((n) => (
          ...
          >
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              {/* Left content */}
              <a href={n.route || "/notifications"} className="space-y-1">
                <h4
                  className={
                    n.userStatus === "Unread"
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <Button
                  size="sm"
                  className="rounded-xl bg-black hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-white flex items-center justify-center gap-1 w-full sm:w-auto"
                ...
                <Button
                  size="sm"
                  variant="destructive"
                  className="rounded-xl w-full sm:w-auto flex items-center justify-center"
                  onClick={async () => {
