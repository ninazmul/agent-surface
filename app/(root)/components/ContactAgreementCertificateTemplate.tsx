  ...
  return (
    <div className="relative w-[210mm] min-h-[297mm] p-12 bg-white text-gray-900 font-serif border-[16px] border-yellow-600 shadow-2xl">
      ...
      <div className="text-center mb-6 relative z-10">
        ...
        <h3 className="text-2xl italic font-semibold my-2 inline-block relative">
          {data.name}
          <span className="absolute left-0 bottom-0 w-full h-1 bg-yellow-600 rounded-full"></span>
        </h3>
      </div>
      ...
      {/* Seal */}
      <div className="absolute bottom-[70px] left-1/2 transform -translate-x-1/2 z-10 drop-shadow-lg">
