                ...
                <TableCell className="w-52">
                  {download.documents?.length > 0 ? (
                    <select
                      ...
                      className="block w-full px-4 py-2 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 border text-center whitespace-nowrap"
                    >
                      <option value="">Select Document</option>
                      {download.documents.map((doc, idx) => (
                        <option key={idx} value={doc.fileUrl} className="whitespace-nowrap">
                          {doc.fileName || `Document ${idx + 1}`}
                        </option>
                      ))}
                    </select>
                  ) : (
                    <span className="block w-full px-4 py-2 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 border text-center whitespace-nowrap">
                      No documents
                    </span>
                  )}
                </TableCell>
