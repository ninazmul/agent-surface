...
const StudentResourceForm = ({ type, resource, resourceId }: StudentResourceFormProps) => {
  ...
  const form = useForm<z.infer<typeof studentStudentResourceFormSchema>>({
    resolver: zodResolver(studentStudentResourceFormSchema),
...
export default StudentResourceForm;
