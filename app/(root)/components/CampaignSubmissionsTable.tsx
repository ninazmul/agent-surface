            ...
            {submissions.map((sub, idx) => (
              ...
              >
                ...
                <TableCell className="w-max font-medium">
                  <div className="min-w-44 line-clamp-1 truncate">
                    {" "}
                ...
                <TableCell className="w-max text-right">
                  <span
                    className="px-4 py-2 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 whitespace-nowrap"
