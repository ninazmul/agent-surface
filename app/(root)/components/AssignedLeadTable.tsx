                    ...
                    <TableCell className="w-max align-top">
                      <div className="w-44">
                        ...
                        >
                          ...
                          <span
                            className={`text-sm text-gray-500 dark:text-gray-300 flex items-center gap-1 line-clamp-1 truncate ${
                          ...
                          <span
                            className={`text-sm text-gray-500 dark:text-gray-300 line-clamp-1 truncate ${
                              lead.isPinned ? "dark:text-gray-500" : ""
                            }`}
                          >
                            {lead.number}
...
export default AssignedLeadTable;
