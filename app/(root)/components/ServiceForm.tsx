  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex flex-col gap-6 rounded-2xl bg-teal-50 dark:bg-gray-800 p-6 shadow-sm"
      >
        <div className="space-y-2">
          <h2 className="text-xl font-semibold text-teal-800 dark:text-gray-100">
            Service Information
          </h2>
        </div>
        {/* Title */}
