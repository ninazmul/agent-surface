...
import UpdateMarketingResourceDialog from "@/components/shared/UpdateMarketingResourceDialog";
            ...
            {paginatedResources.map((resource, index) => {
              return (
                ...
                >
                  ...
                  <TableCell className="w-44 whitespace-nowrap">{resource.fileName}</TableCell>
