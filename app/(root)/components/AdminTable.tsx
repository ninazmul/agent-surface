          ...
          <TableBody>
            {paginatedAdmins.map((admin, index) => (
              ...
              >
                ...
                <TableCell>
                  <div className="whitespace-nowrap">{admin.name}</div>
                </TableCell>
                <TableCell>{admin.email || "No email provided"}</TableCell>
                <TableCell>
                  <Popover>
                    <PopoverTrigger asChild>
                      <span className="w-full px-4 py-2 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 border text-center whitespace-nowrap">
