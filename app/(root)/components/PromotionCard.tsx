    ...
    <div className="relative">
      <Dialog onOpenChange={(open) => open && fetchLeads()}>
        <div className="group bg-gray-50 dark:bg-black cursor-pointer shadow-md hover:shadow-lg rounded-2xl overflow-hidden transition-transform hover:scale-[1.02] relative">
          ...
          <div className="p-5 flex justify-between items-center gap-4">
            ...
            <DialogTrigger asChild>
              <button className="px-3 py-1 text-xs font-semibold rounded-full bg-purple-500 text-white shadow whitespace-nowrap hover:bg-purple-600 transition">
                See Details
              </button>
            </DialogTrigger>
            {timeLeft && (
        ...
        >
          ...
          {promotion.photo && (
            <div className="relative w-full aspect-[16/9] sm:h-80 my-4">
              <Image
                src={promotion.photo}
                alt={promotion.title}
                fill
          ...
          {/* DETAILS */}
          <div className="space-y-5 text-sm leading-relaxed text-gray-700 dark:text-gray-200 break-words">
