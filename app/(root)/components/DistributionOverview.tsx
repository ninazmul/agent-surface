...
const DistributionOverview = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 shadow-md rounded-2xl p-4 mb-6 h-full flex flex-col">
      <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 items-start justify-between w-full mb-4">
        ...
        <select
          ...
          className="px-4 py-2 rounded-2xl bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 border w-full sm:w-auto"
        >
