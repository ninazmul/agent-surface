    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      ...
      >
        <div className="mb-10 border-b border-gray-100 pb-6">
          ...
          <p className="text-gray-500 mt-1">Please fill in the details below.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-x-6 gap-y-8">
          {fields.map((field) => {
            ...
            const isShort = /name|city|zip|state|phone|gender|date/i.test(field.label);
            const gridSpan = isShort ? "md:col-span-2" : "md:col-span-6";

            return (
              <div key={field._id} className={`${gridSpan} flex flex-col space-y-1`}>
