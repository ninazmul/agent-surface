    ...
    <main className="max-w-4xl mx-auto py-10 px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Details below are taken from the lead record and have been verified.
        </p>
      </div>
      ...
      <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-primary-500 to-primary-600 p-6 text-white">
          ...
          <p className="text-sm opacity-90">
            {lead?.email || "Student email not available"}
          </p>
        </div>
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-800">
          <div>
            ...
            <ul className="mt-2 text-sm space-y-1">
              ...
              {lead?.passport?.number && (
                <li>
                  <strong>Passport No.:</strong> {lead.passport.number}
                </li>
              )}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 text-sm space-y-1">
              ...
              {courses.length > 0 && (
                <li>
                  <strong>Commence / Completion:</strong>{" "}
                  {courses
                    .map(
                      (c) =>
