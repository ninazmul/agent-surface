...
const AddResourcePricelistDialog = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <DialogHeader>
          <DialogTitle>Add Resource Price List</DialogTitle>
        </DialogHeader>

        <ResourcePriceListForm type="Create" onSuccess={() => setOpen(false)} />
      </DialogContent>
    </Dialog>
  );
};

export default AddResourcePricelistDialog;
